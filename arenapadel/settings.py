...
INSTALLED_APPS = [
    ...
    'reservations',
    'payments',
    'notifications',  # Nueva app añadida
]
...
PAGO_MOVIL_PHONE = os.getenv('PAGO_MOVIL_PHONE', '04249743328')
PAGO_MOVIL_BANK = os.getenv('PAGO_MOVIL_BANK', 'Banesco')
PAGO_MOVIL_ID = os.getenv('PAGO_MOVIL_ID', 'J 505097962')

# Admin contact info
ADMIN_WHATSAPP_NUMBER = os.getenv('ADMIN_WHATSAPP_NUMBER', '584249743328')
